...
class ActualServerCheckDataStore(private val dataStore: DataStore<Preferences>) {
    ...
    private companion object {
        ...
        private val IS_CHECK_RUNNING_KEY = booleanPreferencesKey("is_actual_server_check_running")
    }
